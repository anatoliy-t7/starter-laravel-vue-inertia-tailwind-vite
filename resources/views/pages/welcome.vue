...
<template layout>
    <div
        class="relative flex justify-center min-h-screen py-4 items-top bg-zinc-100 dark:bg-zinc-900 sm:items-center sm:pt-0"
    >
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div
                class="mt-8 overflow-hidden bg-white shadow dark:bg-zinc-800 sm:rounded-lg"
            >
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    >
                        ...
                        libraries, such as
                        <a href="https://forge.laravel.com" class="underline"
                            >Forge</a
                        >,
                        <a href="https://vapor.laravel.com" class="underline"
                            >Vapor</a
                        >,
                        <a href="https://nova.laravel.com" class="underline"
                            >Nova</a
                        >, and
            ...
            >
                <div class="text-sm text-center text-zinc-500 sm:text-left">
                    <div class="flex items-center">
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            class="w-5 h-5 -mt-px text-zinc-400"
                        >
                            <path
                        ...
                        <svg
                            ...
                            stroke-width="2"
                            viewBox="0 0 24 24"
                            class="w-5 h-5 ml-4 -mt-px text-zinc-400"
                        >
                            <path
                ...
                <div
                    class="space-x-2 text-sm text-center text-zinc-500 sm:text-left"
                >
